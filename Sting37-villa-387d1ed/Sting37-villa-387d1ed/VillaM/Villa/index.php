...
<head>
    ...
    if (isset($_SESSION["username"])) {
        ...
        // Use null coalescing operator to avoid undefined index warning
        $isAdmin = $_SESSION["authenticated"] ?? false;
    }
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-8 col-md-7 py-4">
                    ...
                    <p class="text-muted">Palitan nyo nalang</p>
                </div>
                <div class="col-sm-4 offset-md-1 py-4 text-right">
                    ...
                    <p class="text-muted">Log in to book room.</p>
                    <?php } ?>
                </div>
            </div>
        </div>
...
<main role="main">
    ...
    <section class="jumbotron text-center">
        <div class="container pt-lg-5 pl-5 px-5">
            <h1 class="display-3">palitan nyo lang</h1>
            <p class="lead text-muted">palitan nyo lang</p>
            <p>
                <?php if ($isSessionExists) { ?>
    ...
    <div class="container">
        <div class="pricing-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center">
            ...
            <p class="lead">palitan nyo lang</p>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    <div class="card mb-4 box-shadow">
                        <div class="card-header">
                            <h5 class="my-0 font-weight-normal">Deluxe</h5>
                        </div>
                        <img class="card-img-top" data-src="holder.js/100px225?theme=thumb&amp;bg=55595c&amp;fg=eceeef&amp;text=Thumbnail" alt="Thumbnail [100%x225]" style="height: 225px; width: 100%; display: block;" src="image/3.png" data-holder-rendered="true">
                        <div class="card-body">
                            <p class="card-text">palitan nyo lang</p>
                ...
                <div class="col-md-4">
                    <div class="card mb-4 box-shadow">
                        <div class="card-header">
                            <h5 class="my-0 font-weight-normal">Double</h5>
                        </div>
                        <img class="card-img-top" data-src="holder.js/100px225?theme=thumb&amp;bg=55595c&amp;fg=eceeef&amp;text=Thumbnail" alt="Thumbnail [100%x225]" src="image/1.png" data-holder-rendered="true" style="height: 225px; width: 100%; display: block;">
                        <div class="card-body">
                            <p class="card-text">palitan nyo lang</p>
                            <div class="d-flex justify-content-between align-items-center">
                                <?php if ($isSessionExists) { ?>
                ...
                <div class="col-md-4">
                    <div class="card mb-4 box-shadow">
                        <div class="card-header">
                            <h5 class="my-0 font-weight-normal">Single</h5>
                        </div>
                        <img class="card-img-top" data-src="holder.js/100px225?theme=thumb&amp;bg=55595c&amp;fg=eceeef&amp;text=Thumbnail" alt="Thumbnail [100%x225]" src="image/2.png" data-holder-rendered="true" style="height: 225px; width: 100%; display: block;">
                        <div class="card-body">
                            <p class="card-text">palitan nyo lang</p>
                            <div class="d-flex justify-content-between align-items-center">
                                <?php if ($isSessionExists) { ?>
                                ...
                                <div class="form-group row align-items-center">
                                    ...
                                    <div class="col-sm-9">
                                        <select required class="custom-select mr-sm-2"  name="roomType">
                                            <option value="<?php echo \models\RequirementEnum::DELUXE; ?>">Deluxe</option>
                                            <option value="<?php echo \models\RequirementEnum::DOUBLE; ?>">Double</option>
                                            <option value="<?php echo \models\RequirementEnum::SINGLE; ?>">Single</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group row align-items-center">
  ...
  <div class="form-group row align-items-center">
    ...
    <div class="col-sm-9 bookedDateTxt"></div>
  </div>
  <div class="form-group row align-items-center">
    <label class="col-sm-3 col-form-label font-weight-bold" for="roomPrice">Rates</label>
  ...
  <div class="form-group row align-items-center">
    <label class="col-sm-3 col-form-label font-weight-bold" for="numNights">
      <span class="numNightsTxt"></span> nights
    </label>
    <div class="col-sm-9 roomPricePerNightWrap">
      <span class="peso-sign">₱</span>
...
<div class="container my-5">
      <h2 class="text-center mb-4" style="color:#FFD700;">Find Us</h2>
      <div class="row justify-content-center">
        <div class="col-md-10">
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3858.803771174858!2d120.9702229!3d14.6424536!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3397b53b8de05ceb%3A0x8a47e5c073c6ce22!2sVilla%20Marcela%20Hidden%20Resort!5e0!3m2!1sen!2sph!4v1718030000000!5m2!1sen!2sph"
            width="100%"
            height="350"
...
<footer class="container mt-5">
    <div class="resort-contact-info" style="background:rgb(0, 0, 0); padding: 24px; border-radius: 8px; margin-bottom: 16px;">
        <h5 class="mb-3" style="color:rgb(255, 255, 255);">Contact Us</h5>
        <ul style="list-style: none; padding: 0; font-size: 1.1em;">
            <li>
                <strong>Resort:</strong> Villa Marcela Hidden Resort
            </li>
            <li>
                <strong>Phone:</strong> <a href="tel:09851777771" style="color:rgb(255, 255, 255);">0985 177 7771</a>
            </li>
            <li>
                <strong>Email:</strong> <a href="mailto:villamarcelahiddenresort@gmail.com" style="color:rgb(255, 255, 255);">villamarcelahiddenresort@gmail.com</a>
            </li>
            <li>
                <strong>Facebook:</strong> <a href="https://www.facebook.com/villamarcelahiddenresort/" target="_blank" style="color:rgb(255, 255, 255);">facebook.com/villamarcelahiddenresort</a>
            </li>
        </ul>
    </div>
    <p class="text-center mb-0">&copy; BCP</p>
</footer>
